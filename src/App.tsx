...
function App() {
    ...
    return (
        <div className="App">
            ...
            <Container fixed>
                <Grid container>
                    <AddItemForm addItem={addTodolist} str={'New To Do List'}/>
                </Grid>
                <Grid container spacing={5}>
                    {todolists.map(tl => {
                        ...
                        return (
                            <Grid key={tl.id} item>
                                <Paper variant={"elevation"} elevation={5} style={{padding: '10px'}} >
                                    <Todolist id={tl.id} title={tl.title} tasks={tasksForTodolist}
